...
<div class="row">
  <div class="col-8">
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="fw-bold mb-0">Class List</h5>
      </div>
      <div class="card-body">
                  ...
                  @if (hasPermissionByChild('class_wise_subject'))
                    <div>
                      <a href="{{ route('admin.class.subjects', ['id' => $class->id]) }}"
                        ...
                        data-bs-toggle="tooltip" aria-label="Edit" title="Subject">
  ...
  <div class="col-4">
      ...
      <div class="card">
          <div class="card-header">
            <h5 class="mb-0">Add Class & Sections</h4>
          </div>
          <div class="card-body">
                ...
                <div id="section-container">
                  @foreach(old('section', ['']) as $index => $section)
                    <div class="input-group mb-2">
                        ...
                        <button type="button" class="btn btn-outline-secondary add-section ms-2">
                        <i class=" tf-icons ri-add-line"></i>
                        </button>
                    </div>
                  @endforeach
                </div>
