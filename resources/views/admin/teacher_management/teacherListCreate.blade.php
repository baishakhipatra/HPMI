...
<div class="card p-4">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <div class="card-body">
    <form action="{{ route('admin.teacherlist.store') }}" method="POST">
      @csrf
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-4">
          <div class="form-floating form-floating-outline">
            <textarea name="qualifications" class="form-control" placeholder="Qualifications">{{ old('qualifications') }}</textarea>
        ...
        <div class="col-md-4">
          <div class="form-floating form-floating-outline">
            <textarea name="subjects_taught" class="form-control" placeholder="Subjects Taught">{{ old('subjects_taught') }}</textarea>
      ...
      <div class="row mb-4">
        <div class="col-md-6">
          <div class="form-floating form-floating-outline">
            <textarea name="classes_assigned" class="form-control" placeholder="Classes Assigned">{{ old('classes_assigned') }}</textarea>
